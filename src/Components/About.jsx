...
function About() {
  return (
    <div className='bg-[#fde6bb] flex justify-center items-center '>
      <p className='p-2 text-sm h-[100vh] w-[100vw] text-justify'>
      WINNERS Room is an educational website created by Phenius Peter (wallah) offering lecture notes
       and PDF resources for third-year semester 2 students, particularly those studying Geography and
        Kiswahili. The site provides various course materials to help students prepare for exams, though
         users should note that all content might not be entirely accurate. 
      Wallah wishes all students success in their examinations. For inquiries, contact pheniusjuma@gmail.com.
      </p>
    </div>
  )
}
